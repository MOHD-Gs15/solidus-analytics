...
Current family: **2.1.3** — Core, Analytics, Governance, and Enforcer are aligned on the 2.1.x family (Core rides its own 2.2.x network family per VERSIONING.md; the reflection bridge tolerates both).
